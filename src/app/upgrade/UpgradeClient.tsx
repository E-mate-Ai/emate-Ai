    ...
    <div className="min-h-screen bg-white dark:bg-zinc-950 text-zinc-900 dark:text-zinc-100">
      ...
      <section className="max-w-6xl mx-auto px-6 pt-16 pb-6 text-center">
        <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-blue-50 dark:bg-blue-950/60 border border-blue-200 dark:border-blue-800 text-blue-700 dark:text-blue-300 text-xs font-semibold mb-4">
          <Sparkles size={13} />
          <span>Elevate Your Exam Preparation</span>
        </div>
        ...
        {/* Above-the-fold Quick Action CTA */}
        <div className="mt-6 flex flex-wrap items-center justify-center gap-3">
          <a
            href="#pricing-grid"
            className="px-6 py-3 rounded-full bg-blue-600 hover:bg-blue-700 text-white text-sm font-semibold transition-all shadow-md shadow-blue-500/20 active:scale-95"
          >
            Compare Plans & Upgrade
          </a>
          <Link
            href="/ai-topper-chat"
            className="px-5 py-3 rounded-full border border-zinc-200 dark:border-zinc-800 bg-zinc-50 dark:bg-zinc-900 hover:bg-zinc-100 dark:hover:bg-zinc-800 text-zinc-800 dark:text-zinc-200 text-sm font-semibold transition-all"
          >
            Try Free Workspace
          </Link>
        </div>
      ...
      {/* ── Pricing cards ─────────────────────────────────────── */}
      <section id="pricing-grid" className="max-w-6xl mx-auto px-6 py-10 scroll-mt-20">
      ...
      <section className="max-w-6xl mx-auto px-6 pb-16">
        <div className="rounded-2xl border border-zinc-200 dark:border-zinc-800 bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-950/30 dark:to-indigo-950/30 p-8 flex flex-col sm:flex-row items-center justify-between gap-6">
          ...
          <a
            href="mailto:support@emate-ai.com?subject=Student%20Discount%20Verification"
